export default function Brand({ footer = false }: { footer?: boolean }) {
  return <a className="v21-brand" href="#inicio" aria-label="Montaje Prefabricado, inicio">
    ...
    <span className="brand-text"><strong>MONTAJE<br />PREFABRICADO</strong><span className="mono">{footer ? "montajesprefabricados.com" : "ingeniería · montaje · coordinación"}</span></span>
  </a>;
}
